...
const Blogs = () => {
  return (
    <section className="blogsContent py-[80px] bg-white">
      <div className="container mx-auto">
        <div className="grid gap-10 grid-cols-2 justify-center items-center">
          ...
          <div className="projectRightContent">
            ...
            <div className="sectionTitle mb-[25px]">
              <h2 className="font-monsterratB mb-[20px] text-primaryDark text-fs32">
                {blogsData.title}
              </h2>
              <p className="mb-[20px] font-monsterratR text-primaryDark text-fs18">
