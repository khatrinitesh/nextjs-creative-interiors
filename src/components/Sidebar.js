  ...
  return (
    <>
      <button
        ...
        className={`transition-all rounded-[3px] duration-300 btnHamburger bg-[#dc2626] border-2 border-black w-[30px] px-[3px] h-[30px] absolute top-[50%] translate-y-[-50%] outline-none right-[30px] active:bg-gray-700 z-[99999]  ${
          btnToggle ? "active" : ""
        }`}
      >
